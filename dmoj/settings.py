...
DMOJ_SQL_SAMPLE_DATABASES_ROOT = '/judge/_sql_templates'
DMOJ_MONGO_SAMPLE_DATABASES_ROOT = '/judge/_mongo_templates'
DMOJ_SUBMISSION_FEEDBACK_ROOT = '/judge_submission_feedback'
